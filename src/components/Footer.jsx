...
const Footer = () => {
    ...
    return (
        <footer className="bg-secondary text-black py-6  px-8 w-full sm:px-20 ">
            <div className=" w-full gap-6 2xl:gap-12 mx-auto flex flex-col  items-center justify-between 2xl:px-4">
